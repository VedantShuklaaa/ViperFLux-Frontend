...
import { MarqueeMain } from "@/components/ui/marquee/marquees";
...
const Background: React.FC<BackgroundProps> = ({
    ...
    return (
        <div className={`relative flex h-[110vh] md:h-screen w-full items-center justify-center bg-background z-99 ${className}`}>
            <div
                className={cn(
                    "absolute inset-0 ",
                    `bg-size-[25px_25px]`,
            ...
            />
            <div className="pointer-events-none absolute inset-0 flex items-center justify-center h-full w-full bg-background" style={{ maskImage: "radial-gradient(ellipse at center, transparent 20%, black)" }}></div>
            {children}
        </div>
    )
}
    ...
    return (
        <div className="w-full h-[110vh] md:h-screen flex items-center justify-center">
            <Background className="font-mono flex flex-col gap-10 xl:gap-18">
                ...
                <div className="absolute h-[16vh] w-[80vw] bottom-10 md:bottom-4 2xl:bottom-8 flex flex-col gap-4 items-center justify-center overflow-hidden z-100000">
